<template>
    <div class="app-header">
      <nav role="menubar">
        <router-link role="menuitem" class="home active" v-bind:to="'Home'"><span>Home</span></router-link>
        ...
        <router-link role="menuitem" class="events" v-bind:to="'Events'"><span>Events</span></router-link>
